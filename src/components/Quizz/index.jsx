...
import { Button, Grid, FormControlLabel, Checkbox, Box, Typography } from "@mui/material";
				...
				{questions.map((question, questionIndex) => (
					<div className={styles["question-options"]} key={questionIndex}>
						<div className={styles.question_info}>
							...
							{!readOnly && (
								<QuizOptions
									onClickAddOption={() => handleAddOption(questionIndex)}
									onClickDelete={() => handleDeleteQuestion(questionIndex)}
								/>
							)}
						</div>
